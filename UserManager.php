...
//------------------------------------------function updateMarket---------------------------------
    ...
    public function updatePersona(User $obj){
        ...
        $q->bindValue(':range_motivation1', $obj->range_motivation1(), PDO::PARAM_STR);
        $q->bindValue(':motivation2', $obj->motivation2(), PDO::PARAM_STR);
        $q->bindValue(':range_motivation2', $obj->range_motivation2(), PDO::PARAM_STR);
        $q->bindValue(':motivation3', $obj->motivation3(), PDO::PARAM_STR);
        $q->bindValue(':range_motivation3', $obj->range_motivation3(), PDO::PARAM_STR);
        ...
        $q->bindValue(':introverti', $obj->introverti(), PDO::PARAM_STR);
        $q->bindValue(':analytique', $obj->analytique(), PDO::PARAM_STR);
        $q->bindValue(':loyal', $obj->loyal(), PDO::PARAM_STR);
        $q->bindValue(':passif', $obj->passif(), PDO::PARAM_STR);
        $q->bindValue(':reseau', $obj->reseau(), PDO::PARAM_STR);
        $q->bindValue(':mobile', $obj->mobile(), PDO::PARAM_STR);
        $q->bindValue(':email', $obj->email(), PDO::PARAM_STR);
        $q->bindValue(':media', $obj->media(), PDO::PARAM_STR);
